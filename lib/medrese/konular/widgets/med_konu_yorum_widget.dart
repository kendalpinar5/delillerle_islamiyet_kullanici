...
class MedKonuYorumWidget extends StatefulWidget {
  final MedKonuYorum yorum;
  final GlobalKey<ScaffoldState> scaffoldKey;

  const MedKonuYorumWidget({Key key, this.yorum, this.scaffoldKey})
      : super(key: key);
  @override
  _MedKonuYorumWidgetState createState() => _MedKonuYorumWidgetState();
}

class _MedKonuYorumWidgetState extends State<MedKonuYorumWidget> {
